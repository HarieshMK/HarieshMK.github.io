...
<div style="display: flex; flex-wrap: wrap; gap: 25px; align-items: stretch; position: relative;">
            ...
            <div class="calc-form-grid">
                ...
                <div class="calc-field-group">
                    <div class="label-row">
                        ...
                        <select id="is-metro" class="calc-select" onchange="calculateAll()" style="width: 120px; padding: 8px 12px; border-radius: 10px; font-weight: 700; background: var(--calc-input-bg); border: 2px solid var(--calc-input-border); color: var(--calc-text-main);">
    ...
    </div> <!-- Left column wrapper closes seamlessly here -->
...
<!-- Bottom Layout Area: Holds the static full-width matrix table -->
