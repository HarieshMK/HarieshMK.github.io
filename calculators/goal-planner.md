...
<div class="input-group">
  <div class="label-row">
    ...
    <input type="text" id="goal-name" list="goal-presets" placeholder="Select or type your dream..." style="width: 100%; padding: 10px; border: 2px solid #f1f5f9; border-radius: 10px; font-weight: 600;">
